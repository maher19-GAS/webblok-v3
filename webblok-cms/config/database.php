...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | WebBlok defaults to SQLite for the platform registry so it works on any
    | shared host with zero configuration. Switch to MySQL by setting
    | DB_CONNECTION=mysql in the .env file (no code changes required).
    |
    */
